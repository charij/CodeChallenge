namespace PlanetWars.Client
{
    ...
    public class Bot
    {
        ...
        private Guid? currentTargetId = null;
        ...
        public CommandRequest[] CalculateMovesForTurn()
        {
            ...
            var targetPlanet = currentTargetId == null
                ? notMyPlanets.Skip(new Random().Next(notMyPlanets.Count())).First()
                : notMyPlanets.First(i => i.Id == currentTargetId);
